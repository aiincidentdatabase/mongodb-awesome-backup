...
if [ "x${CLOUDFLARE_ACCOUNT_ID}" != "x" ]; then
  ...
  #r2_copy_file ${CLOUDFLARE_ACCOUNT_ID} ${CLOUDFLARE_API_TOKEN} ${CLOUDFLARE_R2_PRIVATE_BUCKET} ${TARBALL} ${TARBALL_FULLPATH}
  r2_copy_file ${CLOUDFLARE_ACCOUNT_ID} ${CLOUDFLARE_R2_ACCESS_KEY} ${CLOUDFLARE_R2_SECRET_KEY} ${CLOUDFLARE_R2_PRIVATE_BUCKET} ${TARBALL_FULLPATH}
